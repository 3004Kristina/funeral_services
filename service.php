...
<section class="funeral_organization_page_info_wrapper">
    <div class="container">
        <ul class="breadcrumbs">
            ...
            <li><a href="#" class="active">Организация похорон</a></li>
        </ul>
        <h2>Организация похорон</h2>
        <div class="funeral_organization_page_info">
            <div class="info_item">
                <img src="/img/serv.png" alt="image">
            </div>
            <div class="info_item">
                <p>
    ...
    <div class="container">
        ...
        <div class="service_page_arrangements">
            <div class="advantages_item">
                <img src="/img/icons/s1.png" alt="icon">
                <h2>Консультация</h2>
            </div>
            <div class="advantages_item">
                <img src="/img/icons/s2.png" alt="icon">
                <h2>Оформление<br> документов</h2>

            </div>
            <div class="advantages_item">
                <img src="/img/icons/s3.png" alt="icon">
                <h2>Подготовка<br>
                    к церемонии</h2>

            </div>
            <div class="advantages_item">
                <img src="/img/icons/s4.png" alt="icon">
                <h2>Панихида</h2>
            </div>
            <div class="advantages_item">
                <img src="/img/icons/s5.png" alt="icon">
                <h2>Захоронение<br>
                    кремация</h2>
            </div>
            <div class="advantages_item">
                <img src="/img/icons/s6.png" alt="icon">
                <h2>Поминовение</h2>
            </div>
        </div>
    </div>
